...
htmlhelp_basename = 'Transduinodoc'
...
latex_documents = [
    (master_doc, 'Transduino.tex', 'Transduino Documentation',
...
man_pages = [
    (master_doc, 'transduino', 'Transduino Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Transduino', 'Transduino Documentation',
     author, 'Transduino', 'One line description of project.',
     'Miscellaneous'),
]
